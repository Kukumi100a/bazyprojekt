...
docker run --name mongodb-container -e MONGO_INITDB_ROOT_USERNAME=root -e MONGO_INITDB_ROOT_PASSWORD=root -p 27017:27017 -d mongo
...
docker run --name arangodb-container -e ARANGO_ROOT_PASSWORD=root -p 8529:8529 -d arangodb:latest
